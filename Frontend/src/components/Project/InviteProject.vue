    ...
    <v-dialog transition="scale-transition" v-model="visible" max-width="600" close-on-back max-height="500">
        <v-card>
                        ...
                        <v-form ref="form" validate-on="submit">
                            <v-row>
                                ...
                                <v-col cols="12" sm="2" class="d-flex justify-end">
                                    ...
                                    <v-btn class="d-flex d-sm-none rounded-lg" min-width="120" color="primary"
                                        prepend-icon="mdi-plus">Add</v-btn>
                                </v-col>
                            </v-row>
                        </v-form>
                    </v-col>
            ...
            <v-card-actions class="justify-end">
                <v-btn color="primary" variant="elevated" min-width="130" class="mx-4 mb-3 rounded-xl"
                    @click="handleInvite" :disabled="inviteList.length == 0" >
                    invite
                </v-btn>
            </v-card-actions>
        </v-card>
